...
(meditations
 ...
 (= (str "An Oxford comma list of apples, "
         "oranges, "
         "and pears.")
    ((fn [[a b c]] (str "An Oxford comma list of " a ", " b ", and pears."))
 ...
 (= "Test Testerson, 123 Test Lane, Testerville, TX"
    ((fn [jibberish {:keys [street-address city state]}]
       (str (apply str (interpose " " jibberish)) ", " street-address ", " city ", " state))
